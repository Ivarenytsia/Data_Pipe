...
HIT_COUNT_THRESHOLD = 5#RAND_DIGIT_AMOUNT // 2
...
with DAG(
    ...
    #   Your code here.
    task_create_tables >> task_insert_recs 
    task_insert_recs >> [task_action_on_error, task_action_on_gt_threshold, task_action_on_lte_threshold]
    task_get_hit_count >> task_branching >> [task_action_on_lte_threshold, task_action_on_gt_threshold]
